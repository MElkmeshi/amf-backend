...
class AMF {
  ...
  static ClientID = "797ef773-fda9-49a7-ba90-95c5fc0cdd5f";
  static ClientSecret = "Ku5J6FtXF7EmXof0JyPsD4oK/kKlCvBak+QPjYbqQ8g=";
  static TenantID = "e1cbaea0-f8c8-4ce7-a484-ade672f55f8d";
  static ApplicationID = "00000003-0000-0ff1-ce00-000000000000";
  static RefreshToken =
    "PAQABAAEAAAAtyolDObpQQ5VtlI4uGjEP3NnbXEKpihh4vM1R2etaM0CT-G7q9VSGzu8kI9ZMLY43L7mdWri-yZ3-FujYSf-AFBx8LqZHL9pN68WHBqok-s7cvanfUBf7diYqiqSgpKwDT68W0ypty3XRHYr_95n3TmuZALql2HqaHIw0QwBhy2O6khAwHczCQwizr1eEJSpFly-xaE7D1hnkP-83WW4QObXqAe1TVokVZijibkBwqROB8HUCzDTlhrLAm59qXDyw-ZJ7-PKgXt9LRlH76Chai6HgH-KhB6Kls_Xs85PcEyAA";
  static AccessToken;
  static IssueDate;
...
app.post("/api/v1/additem", async (req, res) => {
  ...
  await products.addAttachment(result.ID, req.files.Image.data);
  await addImageToFiles(result.ID);
